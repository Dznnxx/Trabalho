int quantidadePães, quantidadeBroas, totalPaes, totalBroas;
decimal Tpães, Tbroas, totalarrecadado, valorguardado;
...
totalarrecadado = Tpães + Tbroas;

valorguardado = totalarrecadado / 10 * 0.1m;

Console.WriteLine("Total arrecadado: " + totalarrecadado);
Console.WriteLine("Valor a ser guardado na poupança (10%) :  R$ " + valorguardado);
